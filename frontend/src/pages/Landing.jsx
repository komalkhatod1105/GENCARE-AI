        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 py-5 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <div className="font-heading font-bold text-lg">
              GeneCare
              <span className="text-[#1E3F33]">.AI</span>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            <Link
              to="/login"
              className="text-sm font-medium hover:text-[#1E3F33]"
            >
              Sign In
            </Link>
            ...
            <Link
              to="/register"
              className="text-sm font-medium px-4 py-2 rounded-md bg-[#1E3F33] text-white hover:bg-[#152B23] transition-colors"
            >
              Get Started
            </Link>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 py-20 md:py-32 grid md:grid-cols-12 gap-10">
          <div className="md:col-span-7">
            ...
            <div className="mt-10 flex flex-wrap gap-3">
              <Link
                to="/register"
                className="inline-flex items-center gap-2 px-5 py-3 rounded-md bg-[#1E3F33] text-white hover:bg-[#152B23]"
              >
                Create Free Account
            ...
            <div className="mt-12 grid grid-cols-3 gap-6 max-w-md">
              <div>
                <div className="font-heading text-2xl font-semibold text-[#1E3F33]">
                  7
                </div>
